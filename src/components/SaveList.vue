<template>
  <v-card class="mx-8 my-3">
    ...
    <v-list class="mx-10">
      ...
      <v-list-item-group two-line name="title" v-for="(item, i) in dateFilterList" :key="i">
        <v-divider class="mt-0"></v-divider>
        <v-list-item-title v-text="item.date" style="font-size:17px;font-weight:bold;"></v-list-item-title>
        <v-list-item-subtitle v-for="(item, i) in item.itemList" :key="i">
          <v-list-item>
            ...
            <v-btn icon cols="3" @click="recordingDelete(item.rcordingId)">
